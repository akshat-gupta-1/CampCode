...
const Features = () => {
  return (
    <>
      <div
        className="sm:my-4 my-2  w-full flex items-center flex-col gap-y-8"
        id="features"
      >
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 w-full md:gap-y-20 gap-y-10 gap-x-10">
          <div className="flex flex-col gap-y-4">
            ...
            <p className="text-sand-9 max-w-[550px] sm:text-base text-sm">
              ...
              their algorithmic proficiency with key metrics like completion
              rate, time per problem, and accuracy. It also offers personalized
          ...
          <div className="flex flex-col gap-y-4 order-3">
            ...
            <p className="text-sand-9 max-w-[550px] sm:text-base text-sm">
              By providing a centralized location for accessing past problems,
              the this feature streamlines the learning process and promotes
        ...
        <div className="mt-8 w-full flex flex-col items-center" id="benefits">
          <h4 className="sm:text-3xl text-2xl font-semibold text-sand-11 relative mb-4">
            Benefits
